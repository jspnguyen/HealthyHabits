...
import { Box, Button, Center, Divider, Heading, HStack, Image, Link, Modal, ModalBody, ModalContent, ModalHeader, ModalOverlay, Spacer, Text, VStack } from "@chakra-ui/react"
...
export default function Component() {
  ...
  <Divider/>
  <HStack alignItems={`center`} sx={{"padding": "2em", "width": "100%", "height": "60%"}}>
  <VStack sx={{"width": "50%"}}>
  <Heading sx={{"paddingTop": "0.5em"}}>
  {`Start Your Recording Now`}
</Heading>
  <Box sx={{"alignItems": "center", "width": "400px", "height": "280px"}}>
  <Image src={state.home_state.image} sx={{"borderRadius": "40px", "objectFit": "contain", "objectPosition": "center"}}/>
</Box>
  <Spacer/>
</VStack>
  <VStack alignItems={`center`} sx={{"width": "50%"}}>
  <Button onClick={(_e) => addEvents([Event("state.home_state.setStopRecord", {})], (_e))} sx={{"bg": "linear-gradient(271.68deg, #EE756A 0.75%, #756AEE 88.52%)", "color": "white", "_hover": {"shadow": "0 4px 60px 0 rgba(0, 0, 0, 0.3), 0 4px 16px 0 rgba(0, 0, 0, 0.3)"}}}>
  {`Toggle Recording`}
</Button>
</VStack>
</HStack>
  ...
  {`Emotion: `}
  {state.home_state.top_emotions.at(0)}
</Heading>
</Box>
</Box>
</Box>
  ...
  <meta content={`/home.png`} property={`og:image`}/>
