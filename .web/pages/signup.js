...
export default function Component() {
  ...
  <Button onClick={(_e) => addEvents([Event("state.auth_state.signup", {})], (_e))} sx={{"bg": "linear-gradient(271.68deg, #EE756A 0.75%, #756AEE 88.52%)", "color": "white", "_hover": {"shadow": "0 4px 60px 0 rgba(0, 0, 0, 0.3), 0 4px 16px 0 rgba(0, 0, 0, 0.3)"}}}>
  {`Sign up`}
</Button>
</Box>
